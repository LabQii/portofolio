...
export default async function PostDetailPage({ params }: Props) {
  ...
  return (
    <>
      <ReadingProgress />
      <article className="container mx-auto px-4 py-16 sm:py-24 max-w-3xl">
        ...
        <div className="flex items-center gap-4 text-sm text-muted-foreground mb-8 border-b pb-6">
