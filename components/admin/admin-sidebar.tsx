    ...
    <aside className="w-[220px] bg-white border-r border-[#e2e8f0] flex flex-col h-full shrink-0 z-10">
      ...
      <div className="px-4 py-5 border-b border-[#e2e8f0]">
        <div className="flex items-center gap-3">
          <div className="relative w-9 h-9 rounded-full overflow-hidden border border-[#e2e8f0] shrink-0">
            <Image src="/images/profile/foto-profile.jpg" alt="Profile" fill className="object-cover" />
          </div>
